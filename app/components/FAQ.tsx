    ...
    >
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex flex-col items-center gap-2 text-stone-400 text-sm md:flex-row md:gap-2">
            <span className="order-1 md:order-2">Still have questions?</span>
            <a 
                    href="https://wa.me/94773864650" 
                    target="_blank" 
                    rel="noopener noreferrer"
              className="order-2 md:order-3 text-emerald-700 font-bold underline decoration-emerald-700/30 hover:decoration-emerald-700 transition-all inline-flex items-center gap-1"
                >
                  <span>
                    Contact Rajeewa on <br className="md:hidden" /> WhatsApp
                  </span>
